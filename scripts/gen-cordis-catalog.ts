...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  SessionHandoffRelayResult: 'session-handoff result is owned by packages/context/session-handoff/README.md',
  SessionHandoffRequest: 'session-handoff request is owned by packages/context/session-handoff/README.md',
