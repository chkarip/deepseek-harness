...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-panels': { kind: 'none', reason: 'Browser-side UI layout plugin; registers nothing model-facing.' },
  ...
  'packages/client/ui-skill-mode': { kind: 'indirect', reason: 'The popup submits the host /mode command; dsh-skill-mode owns the model-visible mode body and logged state.' },
  ...
  'packages/client/ui-activity-monitor': { kind: 'none', reason: 'Browser-side mascot and telemetry surfaces; they read the snapshot and projections and register nothing model-facing.' },
