...
<a id="deepseek-aidsh-session-handoff"></a>
...
来源：[`packages/context/session-handoff/src/config.ts:10`](../packages/context/session-handoff/src/config.ts)
...
- `@deepseek-ai/dsh-client-ui-activity-monitor`（[`packages/client/ui-activity-monitor/src/index.ts`](../packages/client/ui-activity-monitor/src/index.ts)）
...
- `@deepseek-ai/dsh-client-ui-panels`（[`packages/client/ui-panels/src/index.ts`](../packages/client/ui-panels/src/index.ts)）
...
- `@deepseek-ai/dsh-client-ui-skill-mode`（[`packages/client/ui-skill-mode/src/index.ts`](../packages/client/ui-skill-mode/src/index.ts)）
...
- `@deepseek-ai/dsh-skill-mode` — 需要 `skills` · `systemPrompt`（[`packages/skill/skill-mode/src/index.ts`](../packages/skill/skill-mode/src/index.ts)）
