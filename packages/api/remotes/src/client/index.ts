...
import sessionHandoffRemote from '@deepseek-ai/dsh-session-handoff/remote'
...
export type {} from '@deepseek-ai/dsh-session-handoff/remote'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      commandsRemote, goalsRemote, dynamicRemote, pluginInventoryRemote, messageFeedbackRemote, sessionHandoffRemote,
    ]) {
