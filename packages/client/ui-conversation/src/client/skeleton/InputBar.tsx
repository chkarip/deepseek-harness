...
export function InputBar({
  ...
  const onChange = (e: ChangeEvent<HTMLTextAreaElement>): void => {
    ...
    setDismissed(false)
    setCaretAtEnd(e.target.selectionStart === next.length && e.target.selectionEnd === next.length)
  ...
  // Each U+FFFC placeholder renders as a chip (the textarea's own glyph is
  // invisible, the backdrop chip supplies the visual); the claim hint and the
  // prompt-history completion are ghost text.
