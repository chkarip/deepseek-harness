...
export const zh = {
  ...
  'menu.mergeForks': '合并 {n} 个分支',
  'merge.title': '合并分支到原会话',
  'merge.desc': '将把该会话的 {n} 个分支合并回原会话：分支中的后续对话会追加到原会话，分支会话本身将被永久删除。此操作不可撤销。',
  'merge.confirm': '合并并删除分支',
  'merge.pending': '正在合并分支…',
  'merge.partial': '有 {n} 个分支无法合并（其包含压缩后的内容），已保留：',
...
export const en = {
  ...
  'menu.mergeForks': 'Merge {n} forks',
  'merge.title': 'Merge forks into the original',
  'merge.desc': 'This merges {n} forks of this session back into it: each fork’s later conversation is appended to the original and the fork sessions are permanently deleted. This cannot be undone.',
  'merge.confirm': 'Merge and delete forks',
  'merge.pending': 'Merging forks…',
  'merge.partial': '{n} forks could not be merged (their own work contains compacted content) and were kept:',
